...
router.post("/favorite-meal-plans", addFavoritePlan);
router.delete("/favorite-meal-plans/:planId", removeFavoritePlan);
router.get("/favorite-meal-plans", getFavoritePlans);
